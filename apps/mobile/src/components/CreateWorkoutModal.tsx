...
type CreateWorkoutModalProps = {
  ...
  studentName: string;
  onCancel: () => void;
  onSubmit: (values: CreateWorkoutValues) => Promise<void>;
};
...
export function CreateWorkoutModal({
  ...
  async function handleSubmit() {
    if (nome.trim().length < 2) {
      setValidationError('Informe um nome para a ficha.');
      return;
    }
      ...
      >
        ...
        <LinearGradient colors={['#141B2D', '#070B12']} style={styles.panel}>
          ...
          >
            ...
            <Text style={styles.kicker}>Nova ficha</Text>
            <Text style={styles.title}>Criar ficha para {studentName}</Text>
            <Text style={styles.subtitle}>
              A nova ficha sera criada como ativa e a ficha ativa anterior sera arquivada.
            </Text>
            ...
            <TextInput
              ...
              placeholder="Objetivo, restricoes ou orientacoes gerais"
              placeholderTextColor="#647084"
              ...
              <Pressable disabled={saving} onPress={handleSubmit} style={styles.submitButton}>
                <LinearGradient colors={['#B7FF4A', '#67E76D']} style={styles.submitGradient}>
                  {saving ? (
                    ...
                    <Text style={styles.submitText}>Salvar ficha</Text>
                  )}
                </LinearGradient>
              </Pressable>
            </View>
